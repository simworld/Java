...
////        bug.getPriority(x);
////        bug.getId(stringIDField.getText());
////        bug.getSummary(summaryText.getText());
////        bug.getDescription(descriptionArea.getText());
////        bug.getStepToReproduce(stepsArea.getText());
////        bug.getActual(actualArea.getText());
////        bug.getExpected(expectedArea.getText());
...
//            java.util.logging.Logger.getLogger(OpenBug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
